...
namespace NbuLibrary.Core.Services
{
    ...
    {
        static string[] allowedTags = new[] { "b", "p", "i", "ul", "ol", "li", "br", "strong", "em", "h1", "h2", "h3", "h4", "h5" };
        ...
        public static string ProcessEncodedHtml(string encodedHtml)
        {
            ...
            try
            {
                ...
                Regex targetAttr = new Regex("target=&quot;(_blank|_parent|_self|_top)&quot;", RegexOptions.Compiled);
                Regex hrefAttr = new Regex("href=&quot;", RegexOptions.Compiled);
                var r2 = new StringBuilder();
                int lastMatchEnd = 0;
                foreach (Match m in beginAnchor.Matches(result))
                {
                    r2.Append(result.Substring(lastMatchEnd, m.Index - lastMatchEnd));
