    ...
    function ($, ko, ds, usercontext, nav, router, presenter, tp, entitygrid, EP, datacontext, msgr) {
        ...
        if (usercontext.hasPermission(MODULE_ID, Permissions.Manage)) {
            ...
            router.add('#/nomenclature/:name', function () {
                ...
                grid.bind(query, {
                    Fields: [
                        { Property: 'Value', Label: 'Value', Type: 0 },
                        { Property: 'DisplayOrder', Label: 'DisplayOrder', Type: 1 }
                    ]
                });
                var vm = (function () {
                    ...
                    function create() {
                        ...
                        page.bind(nom, {
                            Fields: [
                                { Property: 'Value', Label: 'Value', Type: 0, Required: true },
                                { Property: 'DisplayOrder', Label: 'DisplayOrder', Type: 1, Required: true }
                            ]
                        });
                    ...
                    return {
                        Nomenclature: tp.get('nom_' + nom.toLowerCase()),
